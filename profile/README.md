...
3. Make sure you are added to the organization [Linear](https://linear.app/afa-tooling) (contact Connor Bernard if needed).
...
5. All PRs should be associated with a Linear ticket in the respective project.
    ...
    - Keep your Linear ticket up to date with the status of your ticket.
...
8. Please review PRs if you feel comfortable with the change types (remember to update the respective Linear tickets as necessary).
